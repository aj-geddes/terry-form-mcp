...
class WebDashboardServer:
        ...
        return web.json_response(
            {
                ...
                "checks": {"terraform": terraform_ready, "terraform_ls": lsp_ready},
                "version": "v3.0.0",
            }
        )
    ...
    async def ai_status(self, request):
        ...
        try:
            ...
            return web.json_response(
                {"error": str(e), "configured": False, "service": "ai"}
            )
    ...
    async def auth_status(self, request):
        ...
        try:
            ...
            return web.json_response(
                {"error": str(e), "configured": False, "service": "auth"}
            )
    ...
    async def github_status(self, request):
        ...
        try:
            ...
            return web.json_response(
                {"error": str(e), "configured": False, "service": "github"}
            )
    ...
    async def terraform_version(self, request):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return web.json_response(
                    {
                        ...
                        "provider_selections": version_data.get(
                            "provider_selections", {}
                        ),
                    }
                )
                ...
                return web.json_response(
                    {"installed": True, "error": "Failed to get version details"}
                )
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    return web.json_response(
                        {"installed": True, "version_string": version_line}
                    )
            except Exception:
                pass
        ...
        return web.json_response(
            {"installed": False, "error": "Terraform not found or error occurred"}
        )
